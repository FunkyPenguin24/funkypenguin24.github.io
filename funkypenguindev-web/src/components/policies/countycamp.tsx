export default function CountyCamp() {
    return (
        <>
            ...
            <p>
                We do not required you to provide us with any personally
                identifiable information that has not been already been provided
                through the Scouting movement's records. The information that we
                require is retained as described in this privacy policy.
            </p> 
            <div>
                <p>
            ...
            <p>This policy is effective as of 30-08-2022</p>
            <p>

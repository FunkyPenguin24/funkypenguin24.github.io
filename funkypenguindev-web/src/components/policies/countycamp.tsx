export default function CountyCamp() {
    return (
        <>
            <strong>Privacy Policy</strong>
            <p>
                North Yorkshire County Scout Council built the NYS Events app as
                a Free app. This SERVICE is provided by North Yorkshire County
                Scout Council at no cost and is intended for use as is.
            </p> 
            <p>
            ...
            <p>
                ...
                in our Terms and Conditions, which are accessible at NYS Events
            ...
            <p>
                We do not require you to provide us with any personally
                identifiable information that has not been already been provided
                through the Scouting movement's records upon signing up to an event.
                This includes your full name, contact number, email, and the Scout 
                group you are a part of. The information that we require is retained 
                as described in this privacy policy and is used only in conjunction with NYS Events.
            </p> 
            <div>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            href="https://www.nys.org.uk/privacy-policy"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
            ...
            <p>This policy is effective as of 23rd August 2023</p>
            <p>
                <strong>Contact Us</strong>
            </p>
            <p>
                If you have any questions or suggestions about our Privacy
                Policy, do not hesitate to contact us at niall.davis@nys.org.uk.
            </p>
        </>
    );
}

export default function Elevens() {
    return (
        <>
            <strong>Privacy Policy</strong>
            <p>
                Niall Davis built the Elevens app as a Free app. This SERVICE is
                provided by Niall Davis at no cost and is intended for use as
                is.
            </p>
            <p>
            ...
            <p>
                ...
                in our Terms and Conditions, which is accessible at Elevens
            ...
            <p>This policy is effective as of 2020-11-07</p>
            <p>
                <strong>Contact Us</strong>
            </p>
            <p>
                If you have any questions or suggestions about my Privacy
                Policy, do not hesitate to contact me at nialldev9@gmail.com.
            </p>
            <p>
